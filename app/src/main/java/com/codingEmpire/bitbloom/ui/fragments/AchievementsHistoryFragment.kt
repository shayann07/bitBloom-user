...
import com.codingEmpire.bitbloom.databinding.FragmentAchievementsHistoryBinding
...
class AchievementsHistoryFragment : BaseFragment() {

    private var _b: FragmentAchievementsHistoryBinding? = null
    ...
    override fun onCreateView(
        ...
        _b = FragmentAchievementsHistoryBinding.inflate(inflater, container, false)
        return b.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vm.fetchAchievementsTxns(userId)

        vm.achievementsTxns.observe(viewLifecycleOwner) { list ->
